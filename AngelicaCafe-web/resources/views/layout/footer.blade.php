<div class="w-full h-[50vh] bg-[#EDDBC7] flex justify-between py-6 px-[10em]">
    ...
    <div>
        ...
        <div class="whatsapp-float mt-8">
        <a href="https://api.whatsapp.com/send?phone=6282121716511&text=*Halo%20saya%20mau%20tanya!*" target="_blank" class="whatsapp-float-icon flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-whatsapp text-green-500 mr-2" viewBox="0 0 16 16">
            ...
            <span class="text-gray-600 font-semibold">Hubungi Kami di WhatsApp</span>
        </a>
    </div>
    </div>
</div>