...
<body>
    ...
    <div class="p-4 sm:ml-64 flex items-center justify-center">
        <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
            ...
            <form action="{{ route('admin.category.update', $kategori->id_kategori) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="mb-4">
                    <label for="nama_kategori" class="block text-gray-600">Nama Kategori</label>
                    <input type="text" name="nama_kategori" id="nama_kategori" value="{{$kategori->nama_kategori}}" class="w-full border rounded px-3 py-2">
                </div>
