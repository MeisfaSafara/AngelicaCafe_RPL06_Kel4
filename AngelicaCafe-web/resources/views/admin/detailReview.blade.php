...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div>
            <a href="/admin/reviews" class="flex items-center">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h1 class="text-xl text-red font-semibold mb-4">ORDER ID : {{$detailReview->order_id}} </h1>
            <h2 class="text-xl font-semibold mb-4">Detail Pembeli</h2>
            <div class="mb-4">
                <div class="text-gray-600 dark:text-gray-400">Nama</div>
                <div class="text-gray-900 dark:text-white">{{$detailReview->user->name}}</div>
            </div>
            <div class="mb-4">
                <div class="text-gray-600 dark:text-gray-400">Review</div>
                <div class="text-gray-900 dark:text-white">{{$detailReview->comment}}</div>
            </div>      
        </div>  
    </div>
